...
Архивная v1 помещалась целиком. Для принятой v2 решение способа сведения с
музыкой принимает `boss` по предложению `sound`; сжимать время сцены не будем.
Просто убрать тишину недостаточно. Замер —
